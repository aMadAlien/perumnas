  ...
  return (
    <main>
      <section className="px-container py-[60px] md:pt-[120px] md:pb-[80px]">
        <div className="container flex gap-8 lg:gap-[5.556vw] max-md:flex-col">
      ...
      <section className="px-container py-[60px] md:py-[120px]">
        <div className="container flex gap-8 lg:gap-[4.444vw] max-md:flex-col">

          <div className="md:w-[var(--smaller-col)">
