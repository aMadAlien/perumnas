    ...
    <main>
      <section className="px-container py-[60px] md:pt-[120px] md:pb-[80px]">
        <div className="container flex max-md:gap-8 md:justify-between max-md:flex-col">
          <h2 className="h2 container__col--smaller">Enjoy Quality Life in Perumnas Housing</h2>
      ...
      <section className="px-container py-[60px] md:pt-[120px] md:pb-[80px]">
        ...
        <div className="container flex max-md:items-center gap-[13px] md:justify-between">
          <div className="container__col--smaller">
            ...
            <Image
              ...
              height={100}
              alt=""
              className="lg:h-[55vh] w-full object-cover rounded-[2px] md:rounded-[8px] hover:brightness-80 transition-all duration-500"
            />
          </div>
          <div className="container__col--larger">
            <Image
              ...
              height={100}
              alt=""
              className="w-full h-auto md:h-[60vh] object-cover rounded-[2px] md:rounded-[8px] mb-4 md:mb-[3vw] hover:brightness-80 transition-all duration-500"
            />
            <Image
              src={DreamImg2}
              width={560}
              height={100}
              alt=""
              className="w-[80%] h-auto aspect-[460/310] object-cover rounded-[2px] md:rounded-[8px] hover:brightness-80 transition-all duration-500"
            />
          </div>
        </div>
      </section>
      ...
      <section className="px-container py-[60px] md:py-[120px]">
        <div className="container flex max-md:gap-8 md:justify-between max-md:flex-col">
          <div className="container__col--smaller">
            <h2 className="h2 mb-8 md:mb-6">Frequently Asked Questions</h2>
            <p className="text-p">If there are question you want to ask.<br /> We will answer all your question.</p>
          </div>
